...
//            max = document.getElementById("txtlist").innerHTML;
           //var max = parseInt(ajfetch('fetchdata.php', 'max', 'events', id));
            ...
            var HTML = "<table ><th style='color:black;' >SRNO</th><th style='color:black;'>USN</th><th style='color:black;'>NAME</th><th style='color:black;'>EMAIL</th><th style='color:black;'>PHONE NO</th>";
            for (var i = 2; i <= min; i++) {
...
$(document).ready(function(){
    $('#course').on('change',function(){
        ...
        if(data){
            ...
            $('#event').html('<option value="">Select degree first</option>');
...
<div class="row">
  ...
  $sql2 = "SELECT  * FROM college ORDER BY name";
                    ...
                    ?>
			         ...
			         <tr><td >Select Degree<font color='red'>*</font></td>
        ...
        ?>
         ...
         <tr><td id="event" >Select Event<font color='red'>*</font></td>
            <td><select id='events' name='events'  onchange='textdisp(this.value);' required>
		      </td></tr>
			<tr>
                <td>
