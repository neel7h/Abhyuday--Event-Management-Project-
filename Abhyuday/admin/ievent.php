...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Events</li>
            </ol>
...

{
    ...
    echo "<td>$subname</td>";
    echo "<td>$tag</td>";
    echo '<td><form action="editevent.php?abc='.$id.'" method="POST"><input type="image" src="edit.ico" width="50px" height="50px" name="abc" id="edit" value='.$id.' /> <input type="button" src="edit.ico" width="50px" height="50px" id="delete" onClick="" value="'.$id.'"> </form></td>';
    echo "</tr>";
    }
}
